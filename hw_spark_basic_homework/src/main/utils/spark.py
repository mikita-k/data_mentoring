...
def get_spark():
    ...
    spark.conf.set("fs.azure.account.oauth.provider.type.bd201stacc.dfs.core.windows.net", properties.get_auth_provider_type())
    spark.conf.set("fs.azure.account.oauth2.client.id.bd201stacc.dfs.core.windows.net", properties.get_auth_client_id())
    spark.conf.set("fs.azure.account.oauth2.client.secret.bd201stacc.dfs.core.windows.net", properties.get_auth_client_secret())
    spark.conf.set("fs.azure.account.oauth2.client.endpoint.bd201stacc.dfs.core.windows.net", properties.get_auth_client_endpoint())
